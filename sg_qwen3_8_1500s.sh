...
HIP_VISIBLE_DEVICES=3 SGLANG_USE_AITER=0 python3 -m sglang.launch_server --model jsonjiao/qwen3-rocm-sft-1500step --attention-backend triton --tp 1 --trust-remote-code --port 30000
