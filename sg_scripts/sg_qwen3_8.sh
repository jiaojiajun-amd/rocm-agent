...
HIP_VISIBLE_DEVICES=4 SGLANG_USE_AITER=0 python3 -m sglang.launch_server --model Qwen/Qwen3-8B --attention-backend triton --tp 1 --trust-remote-code --port 30001
