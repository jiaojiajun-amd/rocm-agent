#!/bin/bash
# Generate SFT training data - Round 5 (v2)
# Output:
#   - SFT data: training_data/sft_large_dataset_r5.json
#   - Trajectories: training_data/sft_large_dataset_r5_trajectories/
...
python /home/jiajjiao/rocm-agent/src/agent_v2/generate_training_data.py \
    ...
    --output /home/jiajjiao/rocm-agent/training_data/sft_large_dataset_r5.json \
