#!/bin/bash
# Generate SFT training data - Round 3 (v3 - with auto history summarization)
# Uses max_context_tokens=24000 in mini.yaml for automatic context management
# Output:
#   - SFT data: training_data_v3/sft_large_dataset_r3.json
#   - Trajectories: training_data_v3/sft_large_dataset_r3_trajectories/
...
python /home/jiajjiao/rocm-agent/src/agent_v2/generate_training_data.py \
    ...
    --output /home/jiajjiao/rocm-agent/training_data_v3/sft_large_dataset_r3.json \
