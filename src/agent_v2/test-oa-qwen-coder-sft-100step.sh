python test_rocm_agent_amd.py test_all_multi_thread \
    ...
    --model "jsonjiao/qwen3-rocm-30B-coder-sft-v4-100step" \
    --docker-server "10.235.85.27:9527" \
    --eval-server "10.235.85.27:9528" \
    --output-dir /home/jiajjiao/rocm-agent/results_mem/rocprimv5_official_agent_qwen3_30B_coder_sft_v4_100step \
