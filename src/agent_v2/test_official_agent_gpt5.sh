python test_rocm_agent_amd.py test_all_multi_thread \
    ...
    --output /home/jiajjiao/rocm-agent/results/rocprimv5_official_agent_gpt.json \
    --simple-output /home/jiajjiao/rocm-agent/results/rocprimv5_official_agent_gpt_simple.json \
