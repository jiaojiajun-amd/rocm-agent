python test_rocm_agent_amd.py test_all_multi_thread \
    ...
    --output-dir /home/jiajjiao/rocm-agent/results_mem_singel/rocprimv5_official_agent_claude_opus_t2 \
    --config /home/jiajjiao/rocm-agent/src/minisweagent/config/mini_without_reflextion.yaml \
    --use-rocm-agent mini \
    --workers 8
