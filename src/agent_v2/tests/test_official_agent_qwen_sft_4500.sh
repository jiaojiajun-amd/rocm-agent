python test_rocm_agent_amd.py test_all_multi_thread \
    ...
    --model "jsonjiao/qwen3-rocm-sft-4500step" \
    --docker-server "10.235.85.27:9527" \
    --eval-server "10.235.85.27:9528" \
    --output /home/jiajjiao/rocm-agent/results/rocprimv5_official_agent_qwen_sft_4500.json \
    --simple-output /home/jiajjiao/rocm-agent/results/rocprimv5_official_agent_qwen_sft_4500_simple.json \
